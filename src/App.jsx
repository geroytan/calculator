    ...
    <Page>
      <Block className="calculator">
        ...
        <div className="grid-container">
          <Button className="button2" onClick={clearDisplay}>C</Button>
          <Button className="button2" onClick={toggleSign}>+/-</Button>
          <Button className="button2" onClick={calculatePercentage}>%</Button>
          <Button className="button1" onClick={() => appendToDisplay('/')}>/</Button>
          ...
          <Button className="button1" onClick={() => appendToDisplay('+')}>+</Button>
          <Button className="button button-zero" onClick={() => appendToDisplay('0')}>0</Button>
